...
import { Photo } from 'src/payload/schema/photo.schema';
import { CreatePhotoRequest, UpdatePhotoRequest } from 'src/payload/request/photo.request';
...
export class PhotoController {
  ...
  @Post()
  async uploadPhoto(@Body() createPhotoRequest: CreatePhotoRequest): Promise<Photo> {
  ...
  @Put(':id')
  async updatePhoto(@Param('id') id: string, @Body() updatePhotoRequest: UpdatePhotoRequest): Promise<Photo> {
