...
import { ReviewDocument } from "../../schema/reviews.schema";
import {
  CreateReviewRequest,
  ReplyReviewRequest,
...
import { ReviewResponse } from "../../payload/response/review.respone";
...
export class ReviewService {
  ...
  async createReply(
    replyReviewDto: ReplyReviewRequest,
    userId: string,
    id: string
  ): Promise<Review> {
    const createReply = {
