...
import { Review } from 'src/payload/schema/review.schema';
import { CreateReviewRequest, UpdateReviewRequest } from 'src/payload/request/review.request';
...
export class ReviewController {
  ...
  @Post()
  async createReview(@Body() createReviewRequest: CreateReviewRequest): Promise<Review> {
  ...
  @Put(':id')
  async updateReview(@Param('id') id: string, @Body() updateReviewRequest: UpdateReviewRequest): Promise<Review> {
